...
## Instructions to do AFTER you run the shefiield [instructions] (https://github.com/mithunpaul08/fever-baselines/tree/find_body#evaluation)

- source activate fever
#To run training alone
...
Copy of Instructions from sheffield :might not be updated. use their instructions [page] (https://github.com/mithunpaul08/fever-baselines/tree/find_body#evaluation)
