...
#Top 1 page
PYTHONPATH=src:lib/DrQA python src/scripts/retrieval/batch_ir.py  --model data/fever/drqatfidf/drqa-tfidf-ngram=2-hash=16777216-tokenizer=simple.npz --count 1 --split train
...
#Top 5 pages
PYTHONPATH=src:lib/DrQA python src/scripts/retrieval/batch_ir.py  --model data/fever/drqatfidf/drqa-tfidf-ngram=2-hash=16777216-tokenizer=simple.npz --count 5 --split train
...
#Top 100 pages
PYTHONPATH=src:lib/DrQA python src/scripts/retrieval/batch_ir.py  --model data/fever/drqatfidf/drqa-tfidf-ngram=2-hash=16777216-tokenizer=simple.npz --count 100 --split train
